		...
		<div class="col-12 text-center pt-5">
			...
			<form id="add-frm" method="POST" action="" class="border p-3 mt-2">
				<div class="control-group col-6 text-left">
					...
					<div>
						<input type="text" id="txtTitle" class="form-control mb-4" name="txtTitle" 
				...
				<div class="control-group col-6 text-left mt-2">
					...
					<div>
						<textarea id="txtShortNotes" class="form-control mb-4" name="txtShortNotes"
				...
				<div class="control-group col-6 text-left mt-2">
					...
					<div>
						<input type="text" id="txtPrice" class="form-control mb-4" name="txtPrice"
				...
				<div class="control-group col-6 text-left mt-2">
					...
					<div>
						<input type="file" id="fileUpload" class="form-control mb-4" name="fileUpload"
