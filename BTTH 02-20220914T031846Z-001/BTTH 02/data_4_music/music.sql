...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2022 at 04:21 AM
...
--
ALTER TABLE `baiviet`
  ADD CONSTRAINT `fk_baiviet_tacgia` FOREIGN KEY (`ma_tgia`) REFERENCES `tacgia` (`ma_tgia`),
  ADD CONSTRAINT `fk_baiviet_theloai` FOREIGN KEY (`ma_tloai`) REFERENCES `theloai` (`ma_tloai`);
COMMIT;
